...
const baseNavItems = [
  { href: "/dashboard", label: "Belege", icon: ReceiptIcon },
  { href: "/trips", label: "Reisen", icon: TripIcon },
  { href: "/receipts/new", label: "Erfassen", icon: PlusIcon },
...
export function Nav() {
  ...
  const navItems = org
    ? [
        ...
        { href: `/org/${org.slug}/settings`, label: "Team", icon: TeamIcon },
        baseNavItems[3],
      ]
    : baseNavItems;

  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 border-t border-gray-200 bg-white/95 backdrop-blur-sm pb-safe">
      {org && (
